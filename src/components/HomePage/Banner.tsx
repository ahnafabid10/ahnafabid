...
const Banner = () => {
  return (
    <section className="home-banner relative flex min-h-screen items-center justify-center overflow-hidden bg-[#07090a] px-4 text-center text-white">
      ...
      >
        <ArrowDown className="h-3.5 w-3.5 text-white/50" strokeWidth={2.5} />
        Scroll to explore
      </a>

      <div className="relative z-10 mx-auto mt-10 w-full max-w-6xl">
        <h1 className="text-[clamp(3.5rem,8vw,7rem)] font-extrabold leading-none tracking-normal text-white/80 drop-shadow-[0_8px_30px_rgba(0,0,0,0.55)]">
          Ahnaf Abid Nirob
        </h1>
